...
const DownLine = (props) => {
  return (
    <div className="relative">
      <div className="text-white font-header absolute top-[calc(15vh+32px)] left-[-95px] text-center">
        <div className="w-60 h-[180px]">
          <img src={props.url} alt="image" />
        </div>
      </div>
      <div className="absolute top-[calc(10vh+32px)] left-4">
        <div className="w-[1px] h-[5vh] bg-white"></div>
      </div>
      <div className="text-white font-header absolute top-[calc(5vh+32px)] left-[-82px] text-center">
